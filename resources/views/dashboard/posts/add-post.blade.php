...
<div class="dashboard-block block-50">
    <form method="POST" action="{{route('posts.store')}}" class="dashboard-form" enctype="multipart/form-data">
        ...
        <div class="dashboard-form-group">
            ...
            <input name="title" type="text" class="dashboard-input" placeholder="Tytuł..." value="{{old('title')}}">
            @error('title')
            <p>Błąd</p>
            @enderror
        </div>
        ...
        <div class="dashboard-form-group">
            ...
            <textarea class="dashboard-input" name="content" cols="30" rows="10"></textarea>
            @error('content')
            <p>Błąd</p>
            @enderror
        </div>
