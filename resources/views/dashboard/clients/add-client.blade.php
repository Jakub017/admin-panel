...
<div class="dashboard-block block-50">
    <form method="POST" action="{{route('clients.store')}}" class="dashboard-form">
        @csrf
        @method('PUT')
        ...
        <div class="dashboard-form-group">
            <label for="tags" class="dashboard-label">Grupy (wymagane, oddzielone przecinkami)</label>
            <input name="tags" type="text" class="dashboard-input" placeholder="kupujący, sprzedający, newsletter..."
                value="{{old('tags')}}">
            @error('tags')
            <p>Błąd</p>
            @enderror
